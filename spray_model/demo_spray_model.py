...
b = 0,0 # TODO check with josh that this is correct                 # m - location of boom centre reletive to GPS
...
if __name__ == '__main__':
    tree_input = list(ast.literal_eval(sys.argv[1]))
    trees = np.transpose(tree_input)
    ...
    inp = {
        ...
        'yaw': yaw,  # degrees (bearing)
    }
    Nozzle_1, Nozzle_2, Nozzle_3, Nozzle_4, Nozzle_5 = test_model(inp, Lb, b, C, R, trees)
    print("{0}{1}{2}{3}{4}".format(Nozzle_1, Nozzle_2, Nozzle_3, Nozzle_4, Nozzle_5))
